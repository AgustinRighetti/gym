                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                                  ...
                                  {socio.planPendiente && (
                                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3rem', padding: '0.2rem 0.5rem', background: '#FF4500', color: '#fff', borderRadius: '4px', fontSize: '0.72rem', fontWeight: 700, width: 'fit-content' }}>
                                      <RefreshCw size={10} /> {PLANES.find(p => p.value === socio.planPendiente?.codigo)?.label}
                                    </span>
                                  )}
                                </div>
                              </td>
                    ...
                    return (
                      <div key={socio.id} className="socio-card" style={{ borderColor: isExpanded ? '#FF450060' : '#222' }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '0.9rem', alignItems: 'center' }}>
                          <span style={{ padding: '0.25rem 0.55rem', background: '#FF450020', color: '#FF4500', borderRadius: '4px', fontWeight: 600, fontSize: '0.78rem' }}>{PLANES.find(p => p.value === socio.plan?.codigo)?.label || socio.plan?.nombre}</span>
                          {socio.planPendiente && <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', padding: '0.2rem 0.5rem', background: '#FF4500', color: '#fff', borderRadius: '4px', fontSize: '0.72rem', fontWeight: 700 }}><RefreshCw size={10} /> {PLANES.find(p => p.value === socio.planPendiente?.codigo)?.label}</span>}
                      ...
                      {asistencias.map((item, idx) => {
                        ...
                        return (
                          <tr key={idx} style={{ borderBottom: '1px solid #2a2a2a', background: item.tieneAlerta ? 'rgba(255,69,0,0.05)' : 'transparent' }}>
                            ...
                            <td style={{ padding: '0.9rem 0.75rem' }}><span style={{ background: '#FF450020', color: '#FF4500', padding: '0.22rem 0.55rem', borderRadius: '4px', fontSize: '0.78rem', fontWeight: 600 }}>{PLANES.find(p => p.value === item.socio.plan?.codigo)?.label || item.socio.plan?.nombre}</span></td>
                            <td style={{ padding: '0.9rem 0.75rem', textAlign: 'center' }}>
                    ...
                    return (
                      <div key={idx} className="asist-card" style={{ borderColor: item.tieneAlerta ? '#FF450060' : '#222' }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', marginBottom: '0.6rem', flexWrap: 'wrap' }}>
                          <span style={{ background: '#FF450020', color: '#FF4500', padding: '0.2rem 0.5rem', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 600 }}>{PLANES.find(p => p.value === item.socio.plan?.codigo)?.label || item.socio.plan?.nombre}</span>
      ...
      <div style={{ display: 'flex', gap: '1.2rem', flexWrap: 'wrap', alignItems: 'flex-start' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', minWidth: 150 }}>
          ...
          <span style={{ background: '#FF450020', color: '#FF4500', padding: '0.35rem 0.7rem', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 700, width: 'fit-content' }}>
            {PLANES.find(p => p.value === socio.plan?.codigo)?.label} — {getPlanPrecio(socio.plan?.codigo)}
          </span>
          {socio.planPendiente && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', background: '#FF4500', color: '#fff', padding: '0.35rem 0.7rem', borderRadius: '4px', fontSize: '0.8rem', fontWeight: 700, width: 'fit-content' }}>
                <RefreshCw size={11} /> Cambio a {PLANES.find(p => p.value === socio.planPendiente?.codigo)?.label} pendiente
              </span>
